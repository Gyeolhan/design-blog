...
![Color, Typography와 같이 기초 요소로 구성되어 있는 Atalassian의 Foundation](https://github.com/Gyeolhan/design-blog/blob/main/assets/images/dsux1-1.png)
...
![앱에서 사용하는 컴포넌트 리스트로 구성되어 있는 Google Material Design의 Components](https://github.com/Gyeolhan/design-blog/blob/main/assets/images/dsux1-2.png)
...
![하나의 버튼을 세부 요소로 분해하고, 사용자 인풋의 상태를 정의하여 설명하는 Google Material Design](https://github.com/Gyeolhan/design-blog/blob/main/assets/images/dsux1-3.png)
